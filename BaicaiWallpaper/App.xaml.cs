...
namespace BaicaiWallpaper
{
    ...
    {
        public static int Height = Convert.ToInt32((Application.Current.Host.Content.ActualHeight * Application.Current.Host.Content.ScaleFactor) / 100);
        public static int Width = Convert.ToInt32((Application.Current.Host.Content.ActualWidth * Application.Current.Host.Content.ScaleFactor) / 100);

        public static double Height_d = Convert.ToDouble(Height);
        public static double Width_d = Convert.ToDouble(Width);
        ...
        private void Application_Launching(object sender, LaunchingEventArgs e)
        {
            ...
            UmengSDK.UmengAnalytics.onLaunching("51c860b256240b951700ff63");

            try
            {
                BaicaiStatisticsSDK.BaicaiStatistics.Init("baicaiwallpaper", new AssemblyName(Assembly.GetExecutingAssembly().FullName).Version.ToString(), (isSuccess, err) =>
                {
#if DEBUG
    if (isSuccess)
        ...
        {
            UmengSDK.UmengAnalytics.onActivated("51c860b256240b951700ff63");
        }
        ...
        {
            await VoiceCommandService.InstallCommandSetsFromFileAsync(new Uri("ms-appx:///Resources/AppVCD.xml"));
        }
